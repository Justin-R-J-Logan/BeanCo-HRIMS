 ...
 * @author Justin
 */
public class Order_PreviousOrderItems extends javax.swing.JInternalFrame {

    /**
     * Creates new form GUI_Distributor
     */
    public Order_PreviousOrderItems() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Order_PreviousOrderItems.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Order_PreviousOrderItems().setVisible(true);
            }
        });
    }
